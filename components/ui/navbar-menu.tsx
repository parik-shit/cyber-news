...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-md boder border-transparent dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-4 px-10 py-4 "
    >
      {children}
    </nav>
  );
